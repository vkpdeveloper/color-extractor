...
from src.color_pipeline.localize import CombinedMaskProvider, HeuristicMaskProvider
...
app = FastAPI(
    title="Color Extractor API",
    version="1.0.0",
    description="Extract dominant apparel colors from an image URL using the pipeline.",
)
